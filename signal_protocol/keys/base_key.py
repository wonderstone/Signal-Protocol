...
if __name__ == "__main__":
    ...
    print(f"   结果一致: {'是' if seed_pub1 == seed_pub2 and seed_priv1 == seed_priv2 else '否'}")
    ...
    print(f"   密钥长度正确: {comparison['key_length_valid']}/{comparison['total_tests']}")
    print(f"   钳制一致性: {comparison['clamping_consistent']}/{comparison['total_tests']}")
    
    success_rate = (comparison['key_length_valid'] / comparison['total_tests']) * 100
    clamp_rate = (comparison['clamping_consistent'] / comparison['total_tests']) * 100
